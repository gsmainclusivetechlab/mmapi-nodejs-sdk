...
let getAnAccountBalanceRequest  = async function() {
    // Construct a request object and set desired parameters
    // Here, GetAnAccountBalanceRequest() creates a GET request to /accounts/{identifierType}/{identifier}/balance
    const request = new mmapi.merchantPayment.GetAnAccountBalanceRequest();
