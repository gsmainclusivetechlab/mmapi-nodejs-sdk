...
// Construct a request object and set desired parameters
// Here, PollToDetermineTheRequestStateRequest() creates a GET request to /requeststates/Place the Server Correlation Id here
...
let retrieveATransactionRequest  = async function() {
    // Construct a request object and set desired parameters
    // Here, RetrieveATransactionRequest() creates a GET request to /transactions/Place Transaction Reference here
    const request = new mmapi.merchantPayment.RetrieveATransactionRequest();
