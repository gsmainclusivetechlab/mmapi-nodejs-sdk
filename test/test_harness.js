 ...
 */
const mobileMoneyApi = require('../lib/index');
...
const environment = () => {
  ...
  return new mobileMoneyApi.core.SandboxEnvironment(consumerKey, consumerSecret, apiKey, securityOption, callbackUrl);
};
 ...
 */
const client = () => new mobileMoneyApi.core.MobileMoneyApiHttpClient(environment());
