...
class MobileMoneyApiEnvironment extends Environment {
  ...
  constructor(consumerKey, consumerSecret, apiKey, securityOption = 'NO_AUTH', baseUrl) {
    super(baseUrl);
...
class SandboxEnvironment extends MobileMoneyApiEnvironment {
  constructor(consumerKey, consumerSecret, apiKey, securityOption = 'NO_AUTH') {
    super(consumerKey, consumerSecret, apiKey, securityOption, SANDBOX);
  }
}
...
class LiveEnvironment extends MobileMoneyApiEnvironment {
  constructor(consumerKey, consumerSecret, apiKey, securityOption = 'NO_AUTH') {
    super(consumerKey, consumerSecret, apiKey, securityOption, LIVE);
  }
}
