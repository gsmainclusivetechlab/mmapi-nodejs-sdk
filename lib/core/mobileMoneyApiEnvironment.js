...
class MobileMoneyApiEnvironment extends Environment {
  ...
  constructor(consumerKey, consumerSecret, apiKey, securityOption = 'NO_AUTH', callbackUrl, baseUrl) {
    super(baseUrl);
...
class SandboxEnvironment extends MobileMoneyApiEnvironment {
  constructor(consumerKey, consumerSecret, apiKey, securityOption = 'NO_AUTH', callbackUrl) {
